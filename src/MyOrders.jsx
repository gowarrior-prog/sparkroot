                ...
                <div key={order.id} className="bg-white border border-slate-200 rounded-sm shadow-sm overflow-hidden transition-all hover:border-slate-300">
                    ...
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-3 flex-wrap">
                          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Order #{order.id}</span>
                  ...
                  {isExpanded && (
                    <div className="border-t border-slate-200 p-5 bg-slate-50/50 animate-in slide-in-from-top-2 duration-200">
                      ...
                      {canCancel(order) && timeLeft && (
                        <div className="mb-4 flex items-center gap-2 bg-amber-50 border border-amber-200 px-4 py-3 rounded-sm">
                          <AlertCircle size={16} className="text-amber-600 flex-shrink-0" />
                          <p className="text-xs font-bold text-amber-700">
                            You can cancel this order within 24 hours. <span className="text-amber-900">{timeLeft}</span> to cancel.
                          </p>
                        </div>
                      )}
