...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white py-12 px-6 sm:px-12 border-t border-gray-900 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium text-gray-300">
              ...
              <li>
                <Link to="/category/fashion" className="hover:text-white transition-colors">Shop</Link>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs text-gray-300 font-medium">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+923447821114" className="hover:text-white transition">+92 3447821114</a>
              </li>
            </ul>
          </div>
