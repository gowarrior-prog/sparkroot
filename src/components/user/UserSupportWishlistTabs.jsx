...
export function UserWishlistTab({ count, onNavigate }) {
  return (
    <div className="bg-white border border-gray-200 rounded-3xl p-6 shadow-xs">
      ...
      <p className="text-xs text-gray-500 mb-4">You have {count} items saved.</p>
      <button
...
export function UserSupportTab({ onNavigate }) {
  return (
