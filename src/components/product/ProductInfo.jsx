...
export default function ProductInfo({
  ...
  return (
    <div className="flex flex-col justify-center space-y-5 sm:space-y-6 pt-4 md:pt-0">
      <div>
      ...
      {product.stock > 0 && product.stock <= 5 && (
        <p className="text-amber-700 bg-amber-50 border border-amber-200 p-3 rounded-lg flex items-center gap-2 font-bold text-xs uppercase tracking-widest">
      ...
      <div className="space-y-3 pt-2">
        <button
          ...
          className={`w-full py-3.5 sm:py-4 px-8 rounded-xl font-black uppercase tracking-widest flex items-center justify-center gap-2.5 transition text-xs sm:text-sm shadow-sm cursor-pointer hover:bg-slate-800 active:scale-98 ${
        ...
        <button
          ...
          disabled={!isStockAvailable}
          className={`w-full py-3.5 sm:py-4 px-8 rounded-xl font-bold uppercase tracking-widest flex items-center justify-center gap-2.5 transition text-xs sm:text-sm border-2 border-black cursor-pointer hover:bg-slate-100 active:scale-98 ${
